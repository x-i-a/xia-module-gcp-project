...
resource "google_iam_workload_identity_pool_provider" "github_provider" {
  ...
  attribute_condition = "assertion.repository_owner == '${each.value["repository_owner"]}' && assertion.repository == '${each.value["repository_name"]}' && assertion.ref.matches('refs/heads/main')"
